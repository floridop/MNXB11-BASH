...
1) Use exactly the commands in `output_examples/some_downloads_fail/command_to_run` and save to file the output of your script:
...
Send me a git URL of your branch `dev-homework4` **on Canvas**.
